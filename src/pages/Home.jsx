  ...
  return (
    <>
      ...
      <section className="mx-auto -mt-8 grid max-w-7xl gap-5 px-4 sm:px-6 lg:grid-cols-3 lg:px-8">
        <Card className="bg-gradient-to-br from-[#fcf8f3] to-[#f8f3ed]">
        ...
        <Card className="bg-gradient-to-br from-[#f8f3ed] to-[#f3ebe0]">
      ...
      <section className="mx-auto mt-16 max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-gradient-to-br from-[#f8f3ed] to-[#f3ebe0] p-8 shadow-soft">
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-2">
          {quickLinks.map((item) => (
            <Link
              key={item.path}
              to={item.path}
              className="rounded-2xl border border-royal/15 bg-gradient-to-br from-[#fcf8f3] to-[#f8f3ed] p-6 text-center shadow-soft transition hover:-translate-y-1 hover:shadow-card"
            >
      ...
      <section className="mx-auto mt-16 max-w-7xl px-4 pb-8 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-orange/30 bg-gradient-to-br from-[#f8f3ed] to-[#f3ebe0] p-8 text-center">
