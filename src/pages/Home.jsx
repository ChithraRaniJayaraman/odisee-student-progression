...
function Home() {
  return (
    <>
      ...
      <section className="relative bg-gradient-to-b from-[#f7c996] via-[#efc3c2] to-[#d8d0f5] px-4 py-20 text-center sm:px-6 lg:px-8 lg:py-28">
      ...
      <section className="mx-auto -mt-8 grid max-w-7xl gap-5 px-4 sm:px-6 lg:grid-cols-3 lg:px-8">
        <Card className="bg-gradient-to-br from-[#f7d4a8] to-[#e8d8f8]">
        ...
        <Card className="bg-gradient-to-br from-[#f6c39a] to-[#f1bdbd]">
        ...
        <Card className="bg-gradient-to-br from-[#cfe9df] to-[#d8d0f5]">
      ...
      <section className="mx-auto mt-16 max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-gradient-to-br from-[#f8cf9f] to-[#eac2d2] p-8 shadow-soft">
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-2">
          {quickLinks.map((item) => (
            <Link
              key={item.path}
              to={item.path}
              className="rounded-2xl border border-royal/15 bg-gradient-to-br from-[#f6cf9e] to-[#ddd0f8] p-6 text-center shadow-soft transition hover:-translate-y-1 hover:shadow-card"
            >
      ...
      <section className="mx-auto mt-16 max-w-7xl px-4 pb-8 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-orange/30 bg-gradient-to-br from-[#f5c796] to-[#d5c9f2] p-8 text-center">
