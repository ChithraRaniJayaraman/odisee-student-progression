      ...
      <section className="mx-auto max-w-7xl space-y-8 px-4 py-12 sm:px-6 lg:px-8">
        ...
        <Card title="The Three Steps in Practice">
          <div className="grid gap-5 md:grid-cols-3">
            <div className="rounded-2xl border border-royal/15 bg-gradient-to-br from-[#f7cd9d] to-[#e7c8dc] p-5">
            ...
            <div className="rounded-2xl border border-royal/15 bg-gradient-to-br from-[#f4c596] to-[#d8cff4] p-5">
            ...
            <div className="rounded-2xl border border-royal/15 bg-gradient-to-br from-[#f7cd9d] to-[#d0e8db] p-5">
