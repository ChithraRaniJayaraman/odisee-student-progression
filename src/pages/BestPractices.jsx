  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-7xl space-y-8 px-4 py-12 sm:px-6 lg:px-8">
        <Card title="Evidence at a Glance" className="bg-gradient-to-r from-main to-lavender">
          <div className="overflow-x-auto">
            <table className="min-w-full border-separate border-spacing-y-3">
              ...
              <tbody>
                {rows.map((row) => (
                  <tr key={row.tool} className="rounded-2xl bg-gradient-to-r from-section to-lavender shadow-soft">
